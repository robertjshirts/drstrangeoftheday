...
const imageDays = [2, 1]; // Manually list the available days based on the files found, reversed
...
export default function Gallery() {
  return (
    <div className="flex min-h-screen flex-col items-center p-4 md:p-12 lg:p-24 space-y-8">
      ...
      <Link href="/" className="mt-12 text-blue-500 hover:text-blue-700 underline">
        Back to Home
      </Link>
    </div>
  );
